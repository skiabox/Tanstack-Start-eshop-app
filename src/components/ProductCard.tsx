...
import { CardHeader, CardTitle, Card, CardContent, CardDescription, CardFooter } from "./ui/card";
  ...
  return (
    ...
    >
      <Card className="h-full px-2 py-4">
        ...
        <CardFooter className="mt-auto pt-0 flex items-center justify-between border-t-0 bg-transparent">
